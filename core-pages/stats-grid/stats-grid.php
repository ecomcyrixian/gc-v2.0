...
$cards_markup      = is_array( $cards ) ? wp_json_encode( $cards ) : '';
$has_ungated_cards = ! empty( $cards_markup ) && false !== stripos( (string) $cards_markup, 'ungated' );
$section_classes   = 'stats-grid' . ( $has_ungated_cards ? ' stats-grid--cards-ungated' : '' );
...
?>
<section class="<?php echo esc_attr( $section_classes ); ?>"<?php echo $bg_style; ?>>
	<div class="stats-grid__container container">
		<?php if ( ! empty( $title ) ) : ?>
			<div class="stats-grid__title">
