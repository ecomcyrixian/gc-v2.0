...
<?php
    $category_name      = $args['category_name'] ?? 'Default Articles Title';
    $category_link     = $args['category_link'] ?? 'Default Articles Title';
    $article            = $args['article'] ?? 3;
    ...
    <div class="container">
        ...
        <div class="card-cont cols3">
            ...
            <?php
                ...
                $args = array(
                    'posts_per_page' => esc_html($article ),  // Limit the number of post
                    ...
                    'category_name'  => $category_name ,  // Use the category slug
                );
