...
$data = function_exists( 'gc_pp_get_author_template_data' )
	? gc_pp_get_author_template_data( $queried )
	: array(
		'ppma_author'      => null,
		'display_name'     => '',
		'first_name'       => '',
            ...
            <div class="container">
                ...
                <div class="author-avatar">
                 ...
                 <div class="author-desc">
                    ...
                    <?php if ( ! empty( trim( (string) $user_job ) ) ) : ?>
                    <p class="job-title">
                    ...
                    <div class="author-desc__bio">
                        ...
                        if ( function_exists( 'gc_author_bio_format_pbsa_fcra_link' ) ) {
                            echo wp_kses_post( nl2br( gc_author_bio_format_pbsa_fcra_link( $bio_plain ) ) );
                        } else {
                            echo nl2br( esc_html( $user_description ) );
                        }
                        ?>
                    </div>
