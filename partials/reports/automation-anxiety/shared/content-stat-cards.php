 ...
 *     @type array  $cards    Card rows with value and text keys.
 * }
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
if ( ! function_exists( 'gc_aar_report_get_stat_card_icon_svg' ) ) {
	/**
	 * FAQ-style card icon used across report stat card grids.
	 */
					...
					<?php foreach ( $cards as $card ) : ?>
						...
						<div class="card-item">
							<h4>
								...
								<span><?php echo gc_aar_report_get_stat_card_icon_svg(); ?></span>
							</h4>
