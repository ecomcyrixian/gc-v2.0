<div id="integrations">
    <div class="container">
        ...
        <div class="integrations-logos">
            ...
            // Flatten all logos for mobile view (2-column grid)
            $all_logos_flat = array_merge($row1, $row2, $row3, $row4);
            
            // Mobile view: single container with all logos in 2-column grid
            ?>
            <div class="integrations-logos-mobile">
                <?php
            ...
            <?php
            // Desktop view: rows with 5-4-5-4 pattern
